...
% Vt estimations
subplot(3, 1, 1), plot(t, Vt_hat_Luem, 'k', 'LineWidth', 1.5); grid on; xlim([0, 8880]); 
...
% SOC estimations
subplot(3, 1, 2), plot(t, Z_hat_Luem, 'r', 'LineWidth', 1.5); grid on; xlim([0, 8880]); 
...
% Vt estimations
subplot(3, 1, 1), plot(t, Vt_hat_Sli, 'g', 'LineWidth', 1.5); grid on; xlim([0, 8880]); 
...
% SOC estimations
subplot(3, 1, 2), plot(t, Z_hat_Sli, 'b', 'LineWidth', 1.5); grid on; xlim([0, 8880]); 
...
% Vt estimations
subplot(3, 1, 1), plot(t, Vt_hat_Super, 'c', 'LineWidth', 1.5); grid on; xlim([0, 8880]); 
...
% SOC estimations
subplot(3, 1, 2), plot(t, Z_hat_Super, 'm', 'LineWidth', 1.5); grid on; xlim([0, 8880]); 
